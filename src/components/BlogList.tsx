 ...
 * 블로그 포스트 목록 컴포넌트
 */
const BlogList = ({ posts, lang, startIndex = 0 }: BlogListProps) => {
  return (
          ...
          >
            <div className="flex flex-col gap-3 md:gap-4 lg:flex-row lg:items-baseline lg:justify-between lg:gap-6 relative z-10">
              ...
              <div className="lg:w-1/2">
                ...
                <div className="mt-2 md:mt-0 md:grid md:grid-rows-[0fr] group-hover:md:grid-rows-[1fr] group-hover:md:mt-4 md:transition-[grid-template-rows] md:duration-500 md:ease-in-out">
