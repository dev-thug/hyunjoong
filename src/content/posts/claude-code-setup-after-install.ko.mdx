...
## 3. Oh My Claude (OMC) — 멀티 에이전트 오케스트레이션
...
✅ 8. Oh My Claude 설치 (멀티 에이전트 오케스트레이션)
✅ 9. Hooks 설정 (자동 포맷팅, 보안 규칙)
✅ 10. 권한 설정 (bypassPermissions 또는 세분화된 allow/deny)
✅ 11. 커스텀 명령어 작성 (반복 작업 자동화)
```
